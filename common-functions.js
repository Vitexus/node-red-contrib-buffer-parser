...
const bcd2number = function (number, digits = 4) {
    const loByte = (number & 0x00ff)
    const hiByte = (number >> 8) & 0x00ff
    let n = 0
    n += (loByte & 0x0F) * 1
...
const number2bcd = function (number, digits) {
    const s = digits || 4 // default value: 4
    let n = 0
...
exports.asyncEvaluateNodeProperty = asyncEvaluateNodeProperty
exports.byteLengthOfUTF8 = byteLengthOfUTF8
